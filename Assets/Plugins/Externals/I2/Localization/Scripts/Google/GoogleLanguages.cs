...
namespace I2.Loc
{
    public static class GoogleLanguages
    {
        ...
        public static Dictionary<string, LanguageCodeDef> mLanguageDef = new Dictionary<string, LanguageCodeDef>(StringComparer.Ordinal)  
		{
			...
			{"Chinese",				new LanguageCodeDef(){Code="zh", 	GoogleCode="zh-CN", HasJoinedWords=true}},
			{"Chinese/Hong Kong",	new LanguageCodeDef(){Code="zh-HK", GoogleCode="zh-TW", HasJoinedWords=true}},
			{"Chinese/Macau", 		new LanguageCodeDef(){Code="zh-MO", GoogleCode="zh-CN", HasJoinedWords=true}},
			{"Chinese/PRC", 		new LanguageCodeDef(){Code="zh-CN", GoogleCode="zh-CN", HasJoinedWords=true}},
			{"Chinese/Simplified", 	new LanguageCodeDef(){Code="zh-CN", GoogleCode="zh-CN", HasJoinedWords=true}},
			{"Chinese/Singapore", 	new LanguageCodeDef(){Code="zh-SG", GoogleCode="zh-CN", HasJoinedWords=true}},
			{"Chinese/Taiwan", 		new LanguageCodeDef(){Code="zh-TW", GoogleCode="zh-TW", HasJoinedWords=true}},
			{"Chinese/Traditional", new LanguageCodeDef(){Code="zh-TW", GoogleCode="zh-TW", HasJoinedWords=true}},
			...
			{"Japanese", 			new LanguageCodeDef(){Code="ja", HasJoinedWords=true}},
			...
			{"Thai", 				new LanguageCodeDef(){Code="th", HasJoinedWords=true}},
