...
namespace I2.Loc
{
    ...
    public class LocalizeTarget_UnityUI_RawImage : LocalizeTarget<RawImage>
    {
        ...
        [I2RuntimeInitialize] static void AutoRegister() { LocalizationManager.RegisterTarget(new LocalizeTargetDesc_Type<RawImage, LocalizeTarget_UnityUI_RawImage>() { Name = "RawImage", Priority = 100 }); }
