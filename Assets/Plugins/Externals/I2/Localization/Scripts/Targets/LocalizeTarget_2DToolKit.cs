...
namespace I2.Loc
{
    ...
    public class LocalizeTarget_2DToolKit_Sprite : LocalizeTarget<tk2dBaseSprite>
    {
        ...
        [I2RuntimeInitialize] static void AutoRegister() { LocalizationManager.RegisterTarget(new LocalizeTargetDesc_Type<tk2dBaseSprite, LocalizeTarget_2DToolKit_Sprite>() { Name = "2DToolKit Sprite", Priority = 100 }); }
