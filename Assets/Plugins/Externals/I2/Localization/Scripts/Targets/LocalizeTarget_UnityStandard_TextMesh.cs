...
namespace I2.Loc
{
    ...
    public class LocalizeTarget_UnityStandard_TextMesh : LocalizeTarget<TextMesh>
    {
        ...
        [I2RuntimeInitialize] static void AutoRegister() { LocalizationManager.RegisterTarget(new LocalizeTargetDesc_Type<TextMesh, LocalizeTarget_UnityStandard_TextMesh>() { Name = "TextMesh", Priority = 100 }); }
