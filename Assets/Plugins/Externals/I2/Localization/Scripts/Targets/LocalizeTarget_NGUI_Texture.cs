...
namespace I2.Loc
{
    ...
    public class LocalizeTarget_NGUI_Texture : LocalizeTarget<UITexture>
    {
        ...
        [I2RuntimeInitialize] static void AutoRegister() { LocalizationManager.RegisterTarget(new LocalizeTargetDesc_Type<UITexture, LocalizeTarget_NGUI_Texture>() { Name = "NGUI UITexture", Priority = 100 }); }
