...
namespace I2.Loc
{
    ...
    public class LocalizeTarget_UnityStandard_GUIText : LocalizeTarget<GUIText>
    {
        ...
        [I2RuntimeInitialize] static void AutoRegister() { LocalizationManager.RegisterTarget(new LocalizeTargetDesc_Type<GUIText, LocalizeTarget_UnityStandard_GUIText>() { Name = "GUIText", Priority = 100 }); }
