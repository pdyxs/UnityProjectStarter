...
namespace I2.Loc
{
    ...
    public class LocalizeTarget_UnityStandard_GUITexture : LocalizeTarget<GUITexture>
    {
        ...
        [I2RuntimeInitialize] static void AutoRegister() { LocalizationManager.RegisterTarget(new LocalizeTargetDesc_Type<GUITexture, LocalizeTarget_UnityStandard_GUITexture>() { Name = "GUITexture", Priority = 100 }); }
