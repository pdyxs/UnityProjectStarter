...
namespace I2.Loc
{
	...
	public class LocalizeTarget_NGUI_Sprite : LocalizeTarget<UISprite>
	{
        ...
        [I2RuntimeInitialize] static void AutoRegister() { LocalizationManager.RegisterTarget(new LocalizeTargetDesc_Type<UISprite, LocalizeTarget_NGUI_Sprite>() { Name = "NGUI UISprite", Priority = 100 }); }
