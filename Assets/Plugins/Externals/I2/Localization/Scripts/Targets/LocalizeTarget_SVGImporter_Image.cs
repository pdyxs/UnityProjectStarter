...
namespace I2.Loc
{
    ...
    public class LocalizeTarget_SVGImporter_Image : LocalizeTarget<SVGImporter.SVGImage>
    {
        ...
        [I2RuntimeInitialize] static void AutoRegister() { LocalizationManager.RegisterTarget(new LocalizeTargetDesc_Type<SVGImporter.SVGImage, LocalizeTarget_SVGImporter_Image>() { Name = "SVG Image", Priority = 100 }); }
