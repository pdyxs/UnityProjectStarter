...
namespace I2.Loc
{
    ...
    public class LocalizeTarget_2DToolKit_Label : LocalizeTarget<tk2dTextMesh>
    {
        ...
        [I2RuntimeInitialize] static void AutoRegister() { LocalizationManager.RegisterTarget(new LocalizeTargetDesc_Type<tk2dTextMesh, LocalizeTarget_2DToolKit_Label>() { Name = "2DToolKit Label", Priority = 100 }); }
