...
namespace I2.Loc
{
    ...
    public class LocalizeTarget_TextMeshPro_UGUI : LocalizeTarget<TMPro.TextMeshProUGUI>
    {
        ...
        [I2RuntimeInitialize] static void AutoRegister() { LocalizationManager.RegisterTarget(new LocalizeTargetDesc_Type<TMPro.TextMeshProUGUI, LocalizeTarget_TextMeshPro_UGUI>() { Name = "TextMeshPro UGUI", Priority = 100 }); }
